...
Promise = SyncPromise;
    ...
    // === jsonc-parser bundle (提取 findNodeAtOffset) ===
    var __jsoncParser = {};
    (function() {
        var module = { exports: {} };
        var exports = module.exports;
  ...
  return function () {
    ...
    1: [function (require, module, exports) {
      (function (factory) {
        ...
        function withFormatting(text, edit, options) {
          ...
          var edits = (0, format_1.format)(newText, {
            offset: begin,
            length: end - begin
    ...
    2: [function (require, module, exports) {
      (function (factory) {
        ...
        function format(documentText, range, options) {
          ...
          var eolFastPathSupported = string_intern_1.supportedEols.includes(eol);
          var numberLineBreaks = 0;
          var indentLevel = 0;
          var indentValue;
          if (options.insertSpaces) {
            var _string_intern_1$cach;
            indentValue = (_string_intern_1$cach = string_intern_1.cachedSpaces[options.tabSize || 4]) !== null && _string_intern_1$cach !== void 0 ? _string_intern_1$cach : repeat(string_intern_1.cachedSpaces[1], options.tabSize || 4);
          } else {
            indentValue = '\t';
          }
          ...
          if (firstToken !== 17) {
            ...
            var initialIndent = indentValue.length * initialIndentLevel < 20 && options.insertSpaces ? string_intern_1.cachedSpaces[indentValue.length * initialIndentLevel] : repeat(indentValue, initialIndentLevel);
    ...
    3: [function (require, module, exports) {
      (function (factory) {
        ...
        function stripComments(text, replaceCh) {
          var _scanner = (0, scanner_1.createScanner)(text),
            parts = [],
            kind,
            offset = 0,
            pos;
    ...
    5: [function (require, module, exports) {
      (function (factory) {
        ...
        exports.cachedSpaces = new Array(20).fill(0).map(function (_, index) {
          return ' '.repeat(index);
        });
    ...
    "jsonc-parser": [function (require, module, exports) {
      ...
      "./impl/scanner": 4
        ...
        __jsoncParser = module.exports;
    })();
    // === end of jsonc-parser bundle ===
...
(function (f) {
  ...
  return function () {
    ...
    "@vscode/l10n": [function (require, module, exports) {
      "use strict";

      var bundle;
      function config(config) {
        if (config && "contents" in config) {
      ...
      function t() {
        ...
        if (typeof firstArg === "string") {
          ...
          return t.apply(undefined, [str].concat(replacements));
        } else {
        ...
        var translated;
        if (bundle) {
          var messageFromBundle = bundle[key];
          if (messageFromBundle) {
            translated = typeof messageFromBundle === "string" ? messageFromBundle : messageFromBundle.message;
          }
        }
        if (typeof translated === "undefined" && typeof Intl !== "undefined" && Intl.namespaces && typeof Intl.getData === "function") {
          var intlEntry = Intl.getData("jsonLanguageService." + key);
          if (typeof intlEntry === "string") {
            translated = intlEntry;
          }
        }
        return format(translated || message, formatArgs);
      }
      var formatRegexp = /\{([^}]+)\}/g;
      function format(template, values) {
        ...
        return template.replace(formatRegexp, function (match, group) {
          return values[group] !== undefined ? values[group] : match;
        });
      }
    ...
    8: [function (require, module, exports) {
      ...
      "vscode-languageserver-textdocument": 29,
      "vscode-languageserver-types": 30
    }],
        ...
        function _validateObjectNode(node) {
          ...
          try {
            for (_iterator0.s(); !(_step0 = _iterator0.n()).done;) {
              ...
              var _key4 = _propertyNode4.keyNode.value;
              seenKeys[_key4] = _propertyNode4.valueNode;
              unprocessedProperties.add(_key4);
            }
          } catch (err) {
            _iterator0.e(err);
          } finally {
          ...
          if (schema.dependentSchemas) {
            for (var _key in schema.dependentSchemas) {
              var _prop = seenKeys[_key];
              var _propertyDeps = schema.dependentSchemas[_key];
              if (_prop && (0, _objects.isObject)(_propertyDeps)) {
                _validatePropertyDependencies(_key, _propertyDeps);
              }
            }
          }
          if (schema.dependencies) {
            for (var _key2 in schema.dependencies) {
              var _prop2 = seenKeys[_key2];
              if (_prop2) {
                _validatePropertyDependencies(_key2, schema.dependencies[_key2]);
              }
            }
          }
          ...
          if (propertyNames) {
            ...
            try {
              for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
                ...
                var _key3 = f.keyNode;
                if (_key3) {
                  _validate(_key3, propertyNames, validationResult, matchingSchemas, context);
                }
              }
            } catch (err) {
              _iterator13.e(err);
    ...
    10: [function (require, module, exports) {
      ...
      "./schemas/draft-2019-09-flat": 19,
      "./schemas/draft-2020-12-flat": 20,
      "@vscode/l10n": "@vscode/l10n"
    }],
        ...
        return _createClass(JSONSchemaService, [{
          ...
          value: function traverseNodes(root, handle) {
            ...
            var collectEntries = function collectEntries() {
              for (var _len = arguments.length, entries = new Array(_len), _key5 = 0; _key5 < _len; _key5++) {
                entries[_key5] = arguments[_key5];
              }
            ...
            var collectMapEntries = function collectMapEntries() {
              for (var _len2 = arguments.length, maps = new Array(_len2), _key6 = 0; _key6 < _len2; _key6++) {
            ...
            var collectArrayEntries = function collectArrayEntries() {
              for (var _len3 = arguments.length, arrays = new Array(_len3), _key7 = 0; _key7 < _len3; _key7++) {
                  ...
                  552: function _(t, e, r) {
                    ...
                    !function (t) {
                      t.joinPath = function (t) {
                        for (var _len5 = arguments.length, e = new Array(_len5 > 1 ? _len5 - 1 : 0), _key9 = 1; _key9 < _len5; _key9++) {
    ...
    "vscode-json-languageservice": [function (require, module, exports) {
      ...
      "./services/jsonCompletion": 11,
      "./services/jsonDocumentSymbols": 12,
      "./services/jsonFolding": 13,
      "./services/jsonHover": 14,
      "./services/jsonLinks": 15,
      "./services/jsonSchemaService": 16,
      "./services/jsonSelectionRanges": 17,
      "./services/jsonValidation": 18,
      "./utils/format": 22,
      "./utils/sort": 27
    }]
    ...
    // 暴露 jsonc-parser 的 findNodeAtOffset（用于 AST 定位）
    module.exports.findNodeAtOffset = __jsoncParser.findNodeAtOffset;
