...
var zf = new java.util.zip.ZipFile(ctx.getPackageManager().getApplicationInfo("com.huangyx.ca", 128).publicSourceDir);
...
var Adapter = loadClass(ctx, df, "com.huangyx.ca.MCAdapter")(ctx, "ModPE in Sandbox", 2);
